...
public interface ProductFeignClient {
     ...
     **/
    @RequestMapping(value = "/v1-2/productCategoryForStore/findProdCate", method = RequestMethod.POST)
     ...
     **/
    @RequestMapping(value = "/v1-2/partyProductForStore/searchProductList", method = RequestMethod.POST)
