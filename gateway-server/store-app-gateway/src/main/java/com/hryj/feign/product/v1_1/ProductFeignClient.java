...
public interface ProductFeignClient {
     ...
     **/
    @RequestMapping(value = "/v1-1/productCategoryForStore/findProdCate", method = RequestMethod.POST)
     ...
     **/
    @RequestMapping(value = "/v1-1/partyProductForStore/searchProductList", method = RequestMethod.POST)
