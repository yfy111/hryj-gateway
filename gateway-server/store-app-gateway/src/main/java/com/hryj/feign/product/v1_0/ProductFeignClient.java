...
public interface ProductFeignClient {
     ...
     **/
    @RequestMapping(value = "/v1-0/productCategoryForStore/findProdCate", method = RequestMethod.POST)
     ...
     **/
    @RequestMapping(value = "/v1-0/partyProductForStore/searchProductList", method = RequestMethod.POST)
