...
public class LoginController {
     ...
     * @create 2018-06-27 22:54
     **/
    @ApiOperation(value = "员工登录", notes = "员工登录")
    @PostMapping("/loginByPwd")
    public Result<AppStaffLoginResponseVO> loginByPwd(@RequestBody StaffLoginRequestVO staffLoginRequestVO){
        ...
        if("temporary".equals(staffLoginRequestVO.getApp_channel())){
            return new Result(CodeEnum.FAIL_FORBIDDEN,"培训包已下线，请重新安装最新版本");
        }
        Result<AppStaffLoginResponseVO> result = staffFeignClient.loginByPwd(staffLoginRequestVO);
