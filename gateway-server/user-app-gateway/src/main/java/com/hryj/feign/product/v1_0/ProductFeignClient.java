package com.hryj.feign.product.v1_0;
...
public interface ProductFeignClient {
     ...
     **/
    @RequestMapping(value = "/v1-0/productCategoryForApp/findProdCate", method = RequestMethod.POST)
     ...
     * @create 2018-07-02 20:16
     **/
    @RequestMapping(value = "/v1-0/partyProductForApp/findRecommendProductList", method = RequestMethod.POST)
     ...
     **/
    @RequestMapping(value = "/v1-0/partyProductForApp/searchProductList", method = RequestMethod.POST)
     ...
     **/
    @RequestMapping(value = "/v1-0/partyProductForApp/getProductInfo", method = RequestMethod.POST)
