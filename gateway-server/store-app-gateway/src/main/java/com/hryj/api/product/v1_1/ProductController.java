 ...
 * @description: APP门店端接口  v1.1
 * @create 2018/7/17 0017 16:43
 **/
@Api(value = "/v1-1/product", tags = "商品 - APP门店端 - V1.1")
@Slf4j
...
public class ProductController {
    ...
    public Result<ListResponseVO<ProductCategoryItemResponseVO>> findProdCate(
        ...
        try {
            ...
            json_str.append("v1.1 - APP门店端查询商品分类 - request:");
            ...
            json_str.append("v1.1 - APP门店端查询商品分类 - response:");
            json_str.append(JSON.toJSONString(result));
            return result;
        } catch (Exception e) {
            log.error("v1.1 - APP门店端查询商品分类接口异常", e);
     ...
     **/
    @ApiOperation(value = "App门店端商品搜素", notes = "商品搜索, 当没有覆盖用户门店和仓库时返回 业务代码:15000")
    ...
    public Result<ListResponseVO<AppProdListItemResponseVO>> searchProductList(@RequestBody(required = false) AppSearchProductRequestVO appSearchProductRequestVO) {
        ...
        try {
            ...
            json_str.append("v1.1 - App门店端商品搜索 - request:");
            ...
            json_str.append("v1.1 - App门店端商品搜索 - response:");
            json_str.append(JSON.toJSONString(result));
            return result;
        } catch (Exception e) {
            log.error("v1.1 - App门店端商品搜索接口异常", e);
            return new Result<>(CodeEnum.FAIL_SERVER, "系统繁忙请稍后再试");
        } finally {
            log.info(json_str.toString());
        }
    ...
    public Result<AppProductInfoResponseVO> getProductInfo(@RequestBody(required = false) ProductValidateRequestVO productValidateRequestVO) {
        ...
        try {
            ...
            json_str.append("v1.1 - APP门店端获取商品详细信息 - request:");
            ...
            json_str.append("v1.1 - APP门店端获取商品详细信息 - response:");
            json_str.append(JSON.toJSONString(result));
            return result;
        } catch (Exception e) {
            log.error("v1.1 - APP门店端获取商品详细信息接口异常", e);
            return new Result<>(CodeEnum.FAIL_SERVER, "系统繁忙请稍后再试");
        } finally {
            log.info(json_str.toString());
        }
